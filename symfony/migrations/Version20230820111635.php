 ...
 */
final class Version20230820111635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT NOT NULL, code VARCHAR(255) NOT NULL, discount DOUBLE PRECISION NOT NULL, type VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
